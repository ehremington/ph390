...
def RK2(function,tf,x0 = 1,t0 = 0,h=2**-10):
    x = [x0]
    t = [t0]
    n = 0
    while t[n]<tf:
...
def RK2next(function,t0,x0,h=2**-10):
    x = x0
    t = t0
    k1 = function(x,t)
    k2 = function(x+k1*h/2,t+h/2)
    x = x+k2*h
    return x
 
def RK4(function,tf,t0 = 0, x0 = 1,h=2**-10):
    '''
    (function,tf,t0 = 0, x0 = 1,h=2**-10)
    '''
    x = [x0]
    t = [t0]
    n = 0
...
def RK4next(function,t0, x0,h=2**-10):
    x = x0
    t = t0
    k1 = function(x,t)
    k2 = function(x+k1*h/2,t+h/2)
    k3 = function(x+k2*h/2,t+h/2)
    k4 = function(x+k3*h,t+h)
...
def cRK4(f,g,tf,y0 = 0,x0 = 0, t0 = 0,h=2**-10):
    '''
    (f,g,tf,y0 = 0,x0 = 0, t0 = 0,h=2**-10)

    f must be dx/dt, and g must be dy/dt, and both must be a function of x,y,t    
    '''
    x = [x0]
    y = [y0]
    t = [t0]
...
def cRK4next(f,g,i,z0,y0,x0,t0,h=2**-10):
    x = x0
    y = y0
    z = z0
    t = t0
    ...
    j1 = g(x,y,z,t)
    l1 = i(x,y,z,t)
    k2 = f(x+k1*h/2,y+j1*h/2,z+l1*h/2,t+h/2)
    j2 = g(x+k1*h/2,y+j1*h/2,z+l1*h/2,t+h/2)
    l2 = i(x+k1*h/2,y+j1*h/2,z+l1*h/2,t+h/2)
    k3 = f(x+k2*h/2,y+j2*h/2,z+l2*h/2,t+h/2)
    j3 = g(x+k2*h/2,y+j2*h/2,z+l2*h/2,t+h/2)
    l3 = i(x+k2*h/2,y+j2*h/2,z+l2*h/2,t+h/2)
    k4 = f(x+k3*h,y+j3*h,z+l3*h,t+h)
    j4 = g(x+k3*h,y+j3*h,z+l3*h,t+h)
    l4 = i(x+k3*h,y+j3*h,z+l3*h,t+h)
    x = x + h/6*(k1+2*(k2+k3)+k4)
    y = y + h/6*(j1+2*(j2+j3)+j4)
    z = z + h/6*(l1+2*(l2+l3)+l4)
    return x,y,z
